...
//    ["Student falls asleep", "At least 5 seconds with eyes closed"],
    ...
    ["Loud noises from the hallway", default_desc],
    ["Someone asks a question that was answered on the slide", default_desc],
    ["8+ bullet points on a slide", default_desc],
...
//    ["Speaker makes a joke & no one laughs", default_desc],
   ...
   // ["Gamma-Strength & Photon-Strength are used interchangeably",default_desc],
    ...
    ["Dates on slides are wrong",default_desc],    
...
//    ["Reference to quantum gravity", default_desc],
    ["Reference to the CMB",default_desc],
